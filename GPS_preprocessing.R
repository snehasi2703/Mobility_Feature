GPS_preprocessing = function(patient_name,
  ...
  path =  "C:\\Users\\singh\\Documents\\ReasearchAssistant_Assignment\\"
  output_filepath = paste0(path,"GPSExample\\")
  patient_output_filepath = paste(output_filepath, patient_name, sep="")
  print(patient_output_filepath)
  ...
  if(file.exists(patient_output_filename)){
    ...
    filelist <- list.files(path=paste(output_filepath,patient_name,"gps",sep="\\"),pattern = "\\.csv$",full.names=T)
